    ...
    messages: [
      {
        role: "system",
        content:
          "Ты специалист-помощник в разработке игр на. Если в сообщении не уазана технология или язык программирования, то предполагай, что вопрос относится к Godot/Gdscript. Сообщение не должно превышать 2000 симовлов.",
      },
